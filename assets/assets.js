...
◦ Managed and updated the official Computer Vision Lab website (https://comvis.mystrikingly.com) to ensure that the information, content, and resources were accessible and up to date.`,
  },
  {
    ...
    description: `◦ Completed fundamental web development modules covering front-end, back-end, API, cloud, and responsive design.
◦ Gained practical skills in HTML, CSS, and JavaScript, including API integration and IDE usage.
◦ Acquired insights into career pathways and best practices in professional web development.`,
    certificateUrl:
