...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append('access_key', '4426f466-b7d9-4164-9f3f-be60e58af15f');
        ...
        {showSuccessPopup && (
          ...
          >
            <motion.div
              ...
              exit={{ y: -20, opacity: 0 }}
              transition={{ duration: 0.3 }}
              className="bg-white dark:bg-dark-hover text-black dark:text-white px-8 py-6 rounded-2xl shadow-2xl text-center max-w-sm w-full"
            >
              <Image
